...
\thispagestyle{empty} 
 \begin{center}
 \vspace{2.0cm} 
 {\bfseries \huge Ausführungsplanoptimierung in PostgreSQL\\}
 \vspace{3.0cm} 
...
\input{Ingo/DBMS}
\input{Ingo/WasIstEinAusfuehrungsplan}
\input{Christof/Abarbeitung}
\input{Christof/Ausfuehrungsplan}
\input{Christof/Kostenparameter}
\input{Christof/Indexe}
\input{Christof/Plananalyse}
\input{Christof/Planvergleich}
\input{Christof/Statistiken}
\input{Ingo/DieDreiScanAlgorithmen}
\input{Ingo/DieDreiJoinAlgorithmen}

\chapter{Umsetzung}\label{Umsetzung}

\input{Ingo/Datenbankentwurf}
\input{Ingo/DerDatengenerator}
\input{Ingo/Queries}
\input{Ingo/WasIstEinHintsSystem}
\input{Ingo/Planerverwirrung}
\input{Ingo/JoinReihenfolgeErzwingen}
\input{Ingo/AusfuerhrungsplaeneQueriesIndex}
\input{Ingo/LangsameAusfuehrungsplaene}
