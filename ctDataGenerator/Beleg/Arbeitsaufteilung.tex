...
Was ist ein Ausführungsplan? &                      &~\ref{WasIstEinAusfuehrungsplan} \\
Die Abarbeitung von Abfragen in PostgreSQL&  ~\ref{Abarbeitung}       & \\ 
Ausführungsplan verändern& ~\ref{Ausfuehrungsplan}        & \\ 
Kostenparameter&   ~\ref{Kostenparameter}      & \\ 
Indexe&          ~\ref{Indexe}                                    & \\ 
Indextypen&    ~\ref{Indextypen}     & \\ 
Pläne mit Bitmap Index Scan&  ~\ref{Plaene}       & \\ 
...
Ausführungspläne für Queries mit und ohne Index&         & ~\ref{AusfuehrungsplaeneFuerQueriesMitUndOhneIndex} \\ 
Was tun bei langsamen Ausführungsplänen?&       			  & ~\ref{WasTunBeiLangsamenAusfuehrungsplaenen} \\ 
