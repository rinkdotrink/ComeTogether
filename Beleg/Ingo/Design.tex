...
\item display all events in table form location based (via GPS in a 50km radius):
   	 à 3 categories (events, food \& beverage, sports- and leisure activities in table form):
\begin{enumerate}
\item date
\item place
\item title of event
