...
\item In der SQLite Datenbank speichern:\\ Als beste und einfachste Möglichkeit das User-Objekt allen notwendigen Activities jederzeit verfügbar zu machen erwieß sich die Speicherung der User-Daten intern in der SQLite Datenbank. Man kann sie aus jeder Activity heraus abfragen, bearbeiten und wieder an den Webservice übertragen, der sie in der PostgreSQL-Datenbank aktualisiert. 
\end{enumerate}
